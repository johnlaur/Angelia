		...
		PROCESS:
			begin
				case (byte_number) 	//save balance of sequence number
					  ...
					  32: Envelope_PWM_max[15:8] <= udp_rx_data;
					  33: Envelope_PWM_max [7:0] <= udp_rx_data;		
					  34: Envelope_PWM_min[15:8] <= udp_rx_data;
					  35: Envelope_PWM_min [7:0] <= udp_rx_data;	
					  36: begin 
			   ...
			   default: if (byte_number > 7'd59) state <= IDLE; 
			   endcase  
		  
				byte_number <= byte_number + 7'd1;
			end
		default: state <= IDLE;
		endcase 
	else state <= IDLE;	
