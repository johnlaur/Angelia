...
module SPI_Alex(Alex_data, SPI_data, SPI_clock, Rx_load_strobe, Tx_load_strobe, spi_clock);
...
6:	begin
	...
	if (count > 3'b000) begin 			// send data twice
